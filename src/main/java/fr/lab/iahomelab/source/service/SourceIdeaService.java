...
import fr.lab.iahomelab.source.controller.dto.CreateSourceIdeaRequest;
import fr.lab.iahomelab.source.controller.dto.SourceIdeaResponse;
...
public class SourceIdeaService {
    ...
    public List<SourceIdeaResponse> getAllBySourceId(UUID sourceId) {
        ...
        return sourceIdeaRepository.findAllBySourceIdOrderByCreatedAtAsc(sourceId)
                .stream()
                .map(this::toResponse)
                .toList();
    }
